...
import { Layout, Row, Divider, Col, Table, Input } from 'antd';
...
const AdminProfile = () => {
    ...
    useEffect(() => {
        if (admin_detalis) {
            setProfile_pic(admin_detalis.profile_pic)
                        ...
                        >
                            <Col span={24} style={{ background: 'rgb(255, 255, 255)', boxShadow: 'rgb(170 170 170) 2px 2px 10px' }}>
                                <Row gutter={[16, 16]} style={{ margin: '5%' }} justify="space-around" className="header bg-gradient-primary pb-8 pt-5">
                                    ...
                                    <Col span={10}>
                                        <img src={`${fileUrl}${profile_pic}`} style={{ width: '250px', height:'250px', marginLeft: '25%', marginBottom: '1rem' }}></img>
                                    </Col>
                                </Row>
                            </Col>
                        </Row>
